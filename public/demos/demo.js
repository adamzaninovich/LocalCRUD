/*
This assumes that either Unity already has a JSON parser, or you have Douglas Crockford's json2 library loaded

Here's a minified version of json2.js

It should go in its own file and be loaded at the beginning.
...
Ok, given that, here's how you query a location:
*/
...
if (httpRequest.error === null) {
  ...
  // response will now contain a javascript object with some metadata and an array of all the nearby items
  response === {
